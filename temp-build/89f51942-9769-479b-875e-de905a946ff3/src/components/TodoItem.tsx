...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  const priorityColors = {
    ...
    high: 'bg-blue-300 text-blue-800 border-blue-500'
  };

  const priorityIcons = {
    low: <div className="w-2 h-2 rounded-full bg-blue-500" />,
    medium: <div className="w-2 h-2 rounded-full bg-blue-700" />,
    high: <div className="w-2 h-2 rounded-full bg-blue-900" />
  };
  ...
  return (
    <Card className={`transition-all duration-200 hover:shadow-md ${
      todo.completed ? 'bg-blue-50 border-blue-200' : 'bg-white border-blue-100'
    } ${isOverdue ? 'border-l-4 border-l-pink-500' : ''} ${
      isDueSoon ? 'border-l-4 border-l-blue-400' : ''
    }`}>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                {todo.description && (
                  <p className={`text-sm mt-1 ${
                    todo.completed ? 'text-blue-300' : 'text-blue-600'
                  }`}>
                    {todo.description}
                  </p>
                )}
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                ...
                <Button
                  ...
                  className="h-8 w-8 p-0 hover:bg-pink-100 hover:text-pink-800"
                >
