...
export const TodoForm: React.FC<TodoFormProps> = ({ todo, onSubmit, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-md max-h-[90vh] overflow-y-auto bg-white text-black">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-white text-black border-gray-300 ${errors.title ? 'border-red-500' : ''}`}
              />
              {errors.title && (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className={`bg-white text-black border-gray-300 ${errors.category ? 'border-red-500' : ''}`}>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-white">
